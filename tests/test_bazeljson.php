...
class BazelJSONTestCase extends KWWebTestCase
{
    ...
    public function testBazelLongOutput()
    {
        // Submit testing data.
        $buildid = $this->submit_data('InsightExample', 'BazelJSON',
            '2ff9e6490c1266f39d962d7476eaed32',
            dirname(__FILE__) . '/data/Bazel/bazel_longOutput.json');
        if (!$buildid) {
            return false;
        }
    ...
    public function testBazelTimeout()
    {
        // Submit testing data.
        $buildid = $this->submit_data('InsightExample', 'BazelJSON',
            '9d8432e8d61c7e3a16748ab5fbf36b51',
    ...
    public function testBazelConfigure()
    {
        // Submit testing data.
        $buildid = $this->submit_data('InsightExample', 'BazelJSON',
            'e6ede8b5aed31fd65b3774373c8e8c1b',
